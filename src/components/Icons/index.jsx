...
export const ProfileIcon = ({ width = '24px', height = '24px', className }) => (
    <svg
        className={className}
        width={width}
        data-e2e=""
...
export const InboxIcon = ({ className, width = '24px', height = '24px' }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const MessageIcon = ({ className, width = '24px', height = '24px' }) => (
    <svg
        className={className}
        fill="currentColor"
...
export const SearchIcon = ({ className, width = '24px', height = '24px' }) => (
    <svg className={className} fill="currentColor" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" width={width} height={height}>
        <path
            fillRule="evenodd"
            clipRule="evenodd"
